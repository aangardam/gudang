...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    @if(Auth::user()->hasRole('Staff Gudang'))
      <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Produk</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            ...
            <li><a class="app-menu__item" href="{{ url('Produk/kembali')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label">Return</span></a></li>
        </ul>
      </li>
    @elseif (Auth::user()->hasRole('Kepala Gudang'))
      <li>
    ...
    @elseif (Auth::user()->hasRole('Kepala Toko'))
      <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Produk</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            <li><a class="app-menu__item" href="{{ url('Produk/Stok')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label">Stok Gudang Pusat</span></a></li>
