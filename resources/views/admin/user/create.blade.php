  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h5>Tambah User</h5>
        <hr>
        <form class="forms-sample" action="{{ action('UserController@store')}}" method="post" >
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="row">
              <label for="password" class="col-md-2">Ulangi Password <span
                ...
                <div class="col-md-10">
                  <div class="input-group">
                    <input id="password2" type="password" class="form-control" placeholder="Konfirmasi Password" name="password2" required>
                    <span class="input-group-btn">
